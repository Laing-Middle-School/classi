...
echo '<br><br>';
echo '<form method="post">' . '<b>Canvas Access Token: </b>' . '<input id="canvas-token" name="canvas-token" placeholder="Your Access Token Generated by Canvas"><input type="submit" name="canvasTokenBtn" value="Set Access Token"/></form>';
echo '<br><br><br>';
...
if(isset($_POST['canvas-token'])) {
    $redis->hset('canvas_token', $_COOKIE['email'], $_POST['canvas-token']);
    successMessage();
  }
